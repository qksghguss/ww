...
export function DashboardPage() {
  ...
  }, [issueRequests, purchaseRequests]);
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>최근 요청을 기반으로 월별 처리량을 확인하세요.</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>최근 지급 요청 기준 상위 품목입니다.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {lowStock.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>임계치 이하 품목을 빠르게 확인하세요.</CardDescription>
              </CardHeader>
